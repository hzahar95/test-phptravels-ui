...
//    }
    ...
    private EmailUtils(EmailFolder emailFolder) throws MessagingException {
        ...
        String server = getEmailServerFromProperties();
        String username = getEmailUsernameFromProperties();
        String password = getEmailPasswordFromProperties();

        Session session = Session.getInstance(properties);
        Store store = session.getStore(getEmailProtocolFromProperties());
    ...
    private static String getEmailAddressFromProperties() {
    ...
    private static String getEmailProtocolFromProperties() {
        return System.getProperty("mail.transport.protocol");
    }

    private static int getEmailPortFromProperties() {
    ...
    private void openEmail(Message message) throws Exception {
        message.getContent();
    }
    ...
    private int getNumberOfUnreadMessages() throws MessagingException {
